...
//MacOS Intel
//set GOOS=darwin&&set GOARCH=amd64&&go build -a -ldflags="-s -w" -installsuffix cgo -o main main.go

//MacOS M1
//set GOOS=darwin&&set GOARCH=arm64&&go build -a -ldflags="-s -w" -installsuffix cgo -o main main.go
